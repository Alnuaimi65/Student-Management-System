            ...
            if(mysqli_stmt_execute($stmt)){
                ...
                if(mysqli_stmt_num_rows($stmt) == 1){
                    ...
                    if(mysqli_stmt_execute($stmtDel)){
                        ...
                        header("location: DegreesDashboard.php");
...
<body>
    ...
    <div class="wrapper">
        <h1>Remove Degree</h1>
        <p>Please Degree Code of the degree to remove.</p>
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <p>Back to Degree Dashboard <a href="DegreesDashboard.php">Click Here</a>.</p>
        </form>
    </div>    
    </div>    
</body>
