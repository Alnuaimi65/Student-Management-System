<?php
   ...
   if($_SERVER["REQUEST_METHOD"] == "POST") {
      ...
      $query = $db->query("SELECT id FROM student WHERE email = '$myusername' and password = '$mypassword'");
        $count = 0;
      ...
      <div align = "center">
         <div style = "width:300px; border: solid 1px #fff; " align = "left">
            ...
            <div style = "margin:30px">
               ...
               <p>Sign Up New Account<a href="StudentPortalSignup.php">Click Here</a>.</p>
